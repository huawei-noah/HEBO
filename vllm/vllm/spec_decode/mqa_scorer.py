...
class MQAScorer(SpeculativeScorer):
    ...
    def score_proposals(
        ...
        post_process_KV = None
        if target_sampler_output.post_process_KV is not None:
            post_process_KV = target_sampler_output.post_process_KV.reshape(
                bs, (k + 1), -1)
        ...
        return SpeculativeScores(probs=all_probs,
                                 ...
                                 post_process_KV=post_process_KV)
