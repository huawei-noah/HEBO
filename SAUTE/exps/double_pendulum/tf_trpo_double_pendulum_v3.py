...
def run_tf_trpo_double_pendulum_v3(        
        experiment_name:str=None, 
        num_exps:int=1, 
        smoketest:bool=True
        ):
    """Smart generalization to different safety budgtes for the double pendulum Saute TRPO (testing only)."""          
    if experiment_name is None:
        experiment_name = 'smart_generalization'         
    ...
    test_safety_budgets = [20.0, 40.0, 60.0, 80.0]         
