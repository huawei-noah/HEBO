...
class HyperOptTool:
    ...
    def __init__(self, bo_steps: int, path_to_python: str, workspace_path: str):
        ...
        self.path_to_python = self.get_path_to_python(path_to_python)

    def get_path_to_python(self, path_to_python: str) -> str:
        while not os.path.exists(path_to_python):
            python_exe = input(
                ...
                f" executable to use for the {self.name}, but {path_to_python} does not exists...\n"
