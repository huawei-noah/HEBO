...
@dataclass
class SparseConfig(TrainingArguments):
    r"""
    Initialize SparseConfig.
    ...
    alpha: float = 1.0
    version: int = 1
    mask_model: Literal["simple_last", "ml_last", "ml_all", "simple_all", "random", "binary_last", "binary_all"] = "simple_all"
    mask_layer_activation: Literal["relu","resc","none"] = "relu"
    mask_mixer_activation: Literal["relu","resc","none"] = "relu"
    mask_dropout: float = 0.01
    mask_weight_decay: float = 0.01
    mask_on_reward: bool = True
    mask_on_kl: bool = True
    rw_kl_independent: bool = False
    ...
    l1_norm_param_u: Optional[float] = 0
    l1_norm_param_d: Optional[float] = 0
    l0_norm_param: Optional[float] = 0
